        ...
        <>
            ...
            <section className="section" id="projects">
                ...
                <div className="project-grid">
                    ...
                    <div className="project-links">
                        ...
                        <a href="./portfolio/CV_Sylvain_Crouzier.pdf" target="_blank" rel="noreferrer">Télécharger le CV ↗</a>
                    </div>
                    </div>
            ...
            <section className="section" id="contact" style={{borderBottom:"none"}}>
                ...
                <div className="contact-grid">
                    ...
                    <div className="contact-row"><span>cv</span><a href="./portfolio/CV_Sylvain_Crouzier.pdf" target="_blank" rel="noreferrer">télécharger (pdf)</a></div>
                    </div>
                </div>
                </div>
            </section>
